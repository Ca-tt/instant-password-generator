...
export const siteContent = {
  siteTitle: {
    ...
    Hindi: "त्वरित पासवर्ड जनरेटर 🚀",
    French: "Générateur de mots de passe instantané 🚀",
    Bengali: "তাৎক্ষণিক পাসওয়ার্ড জেনারেটর 🚀",
  ...
  copyActionMessage: {
    ...
    Hindi: "कॉपी करने के लिए पासवर्ड पर क्लिक करें",
    French: "Cliquez sur le mot de passe pour copier",
    Bengali: "পাসওয়ার্ডটি কপি করতে ক্লিক করুন",
  ...
  thankYouMessage: {
    ...
    Arabic: "تم نسخ كلمة المرور 👌 شكراً لك على نسخ كلمات المرور معنا!",
    Hindi: "पासवर्ड कॉपी किया गया 👌 हमारे साथ पासवर्ड कॉपी करने के लिए धन्यवाद!",
    French: "Mot de passe copié 👌 Merci de copier les mots de passe avec nous!",
    Bengali: "পাসওয়ার্ড কপি হয়েছে 👌 আমাদের সাথে পাসওয়ার্ড কপি করার জন্য ধন্যবাদ!",
  ...
  copyCounter: {
    ...
    Hindi: "पासवर्ड कॉपी किया गया XXX बार",
    French: "Mot de passe copié XXX fois",
    Bengali: "পাসওয়ার্ড কপি হয়েছে XXX বার",
    Portuguese: "Senha copiada XXX vezes"
  }
}
